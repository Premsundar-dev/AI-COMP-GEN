...
const Home = () => {
  ...
  //   apiKey: "AIzaSyAK4gFdkrP4SMGjIW-31GPjJJ8gBMCGaTQ"
  // });
  ...
  async function getResponse() {
    ...
    try {
      ...
      // Send prompt + selected framework to your backend API
      ...
      // Extract code between ``` blocks (your helper already does this)
      setCode(extractCode(output));
      setOutputScreen(true);
    } catch (error) {
      console.error(error);
      toast.error("Something went wrong while generating code");
